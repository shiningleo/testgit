...
namespace TestADWinform
{
    public partial class Form1 : Form
    {
        ...
        private static DirectoryEntry GetDirectoryObject()
        {
            ...
            try
            {
                entry = new DirectoryEntry("LDAP://172.16.253.234", "Administrator", "", AuthenticationTypes.Secure);
                //entry = new DirectoryEntry("LDAP://192.168.100.100", "Administrator", "", AuthenticationTypes.Secure);
            }
            catch (Exception ex)
            {
            }
        ...
        /// <summary>
        /// Office365Users组织下的beijing组织下的用户操作
        /// </summary>
        /// <param name="commonName">带查询用户名称</param>
        /// <param name="ouName">根组织名称</param>
        /// <returns></returns>
    ...
    public  bool DeleteADUser()
    {
      ...
      return result; 
        ...
        public void SendEmail() 
        {
            ...
            var reciver = ConfigurationManager.AppSettings["reciver"];// txt_Reciver.Text;
            var content = ConfigurationManager.AppSettings["content"];//rtxt_Content.Text;
            MailMessage message = new MailMessage();
            //设置发件人,发件人需要与设置的邮件发送服务器的邮箱一致
            MailAddress fromAddr = new MailAddress("762004031@qq.com");
